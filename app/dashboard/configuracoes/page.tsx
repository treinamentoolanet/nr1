...
import { Settings, Save, Loader as Loader2, Plus, Pencil, Trash2, X, CircleAlert as AlertCircle, Zap, RotateCcw, TrendingUp, ShoppingCart, CircleCheck as CheckCircle2, Rocket } from 'lucide-react';
    ...
    <div>
      <div className="mb-8 flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground mt-1">Configure parametros globais e marketplaces</p>
        </div>
                  ...
                  <div key={m.id} className="flex items-center justify-between p-4 bg-muted/30 rounded-xl border border-border/50">
                    <div>
                      ...
                      <div className="text-xs text-muted-foreground mt-0.5">
                        Taxa: {m.taxa}% + tarifa fixa: R$ {m.tarifa_fixa.toFixed(2)}
                      </div>
                    </div>
